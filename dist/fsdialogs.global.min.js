"use strict";var fsdialog=(()=>{var m=Object.defineProperty;var C=Object.getOwnPropertyDescriptor;var h=Object.getOwnPropertyNames;var v=Object.prototype.hasOwnProperty;var O=(l,a)=>{for(var u in a)m(l,u,{get:a[u],enumerable:!0})},x=(l,a,u,n)=>{if(a&&typeof a=="object"||typeof a=="function")for(let t of h(a))!v.call(l,t)&&t!==u&&m(l,t,{get:()=>a[t],enumerable:!(n=C(a,t))||n.enumerable});return l};var L=l=>x(m({},"__esModule",{value:!0}),l);var I={};O(I,{fsAlert:()=>f,fsDialog:()=>c,fsPrompt:()=>p,fsSuccess:()=>g});function f(l,a="Alert"){return c([{text:"OK",value:"OK",class:"btn btn-sm btn-danger"}],l,a,{headClass:"bg-danger text-white",closeButton:!0})}function g(l,a="Success"){return c([{text:"OK",value:"OK",class:"btn btn-sm btn-success"}],l,a,{headClass:"bg-success text-white",closeButton:!0})}function c(l,a,u,n={}){n==null&&(n={});let t={headClass:"",closeButton:!1};n.headClass&&(t.headClass=n.headClass),n.closeButton&&(t.closeButton=n.closeButton),n.container&&(t.container=n.container);let e="400px";n.width&&(e=n.width);let s=[];if(l.length==0)s=[{value:"OK",text:"OK",class:"btn btn-sm btn-light"}];else for(let i of l){let r={value:"",text:"",class:"btn btn-sm"};i.value?r.value=i.value:r.value="OK",i.text?r.text=i.text:r.text=i.value,i.class?r.class=i.class:r.class="btn btn-sm",s.push(r)}let o=document.createElement("dialog");return o.classList.add("fs-dialog-modal"),e!="auto"?o.style.width=e:o.classList.add("fs-dialog-auto"),o.innerHTML=M(s,a,u,t),t.container?t.container?.append(o):document.body.append(o),new Promise(i=>{o.showModal(),o.addEventListener("cancel",r=>{r.preventDefault()}),document.querySelectorAll(".fs-close-modal").forEach(r=>{r.addEventListener("click",b=>{let d=b.currentTarget.dataset?.return;o.close(),o.remove(),d!==void 0&&i(d)})})})}function M(l,a,u,n){let t=l.map(s=>`<button data-return="${s.value}"
